...
public class test : MonoBehaviour
{
    ...
    public void Save()
    {
        ...
        Functions.SaveByJson("test", gridData);
    ...
    public void Refresh()
    {
        ...
        for (var i1 = 0; i1 < objects.GetLength(1); i1++)
        {
            ...
            if (checkObjects.Count == 0)
            {
                ...
                gameObject.GetComponent<Battalion>().BattalionData.Dir =
                    VARIABLE.GetComponent<Battalion>().BattalionData.Dir;
                gameObject.GetComponent<Battalion>().BattalionData.LoadBattalion(1,
                    VARIABLE.GetComponent<Battalion>().BattalionData.BattalionType);
            }
            ...
            GameObject go = Instantiate(VARIABLE, GridManger2.transform.parent.Find("BattalionList"),
                false);
            go.GetComponent<Battalion>().BattalionData.Dir = VARIABLE.GetComponent<Battalion>().BattalionData.Dir;
            go.GetComponent<Battalion>().BattalionData.LoadBattalion(1,
                VARIABLE.GetComponent<Battalion>().BattalionData.BattalionType);
        }
    }
    ...
    public void Load()
    {
        GridData gridData = Functions.LoadByJson("test");
